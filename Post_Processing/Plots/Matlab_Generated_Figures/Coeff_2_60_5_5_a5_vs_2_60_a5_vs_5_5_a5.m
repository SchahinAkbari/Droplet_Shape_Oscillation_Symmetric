...
plot(T_12_2_60_5_5_star(1:10:CutOff),A_12_2_60_5_5_star(6,1:10:CutOff),'-.','color','k','LineWidth',2)
plot(T_12_2_60_star(1:10:CutOff),A_12_2_60_star(6,1:10:CutOff),'--','color',Colors{1},'LineWidth',2)
plot(T_12_5_5_star(1:10:CutOff),A_12_5_5_star(6,1:10:CutOff),'-','color',Colors{2},'LineWidth',2)
grid on
grid minor
...
ylabl = ylabel('$a_5^{*}(t)$','FontSize',14);
