...
Asymmetric/
Files for pre-processing and post-processing of asymmetric droplet oscillations
...
The files provided here are subject to licensing conditions involving:

Schahin Akbari

Technische Universität Darmstadt (TU Darmstadt)

Redistribution, modification, or usage of these files is only permitted with proper attribution.

Any use or distribution must clearly state:
...
If these files are used in scientific, academic, or technical work, proper acknowledgment of the author and institution is required.