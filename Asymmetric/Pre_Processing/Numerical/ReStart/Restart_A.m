...
Amplitude = 50;
% Read last TimeSteps
filename = strcat(int2str(n),'_',int2str(InitialDeformMod),'_',int2str(Amplitude),'_',int2str(LastTimeStep),'VectorSpeicherA.txt');
[VectorSpeicherA,delimiterOut]=importdata(filename);
filename = strcat(int2str(n),'_',int2str(InitialDeformMod),'_',int2str(Amplitude),'_',int2str(LastTimeStep),'VectorSpeicherB.txt');
