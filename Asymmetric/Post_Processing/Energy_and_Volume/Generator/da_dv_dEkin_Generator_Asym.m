...
dA2 =  sqrt(-R2^2*(diff(R2,zetaa)^2*zetaa^4 - 2*diff(R2,z Trasetaa)^2*zetaa^2 - R2^2*zetaa^2 + diff(R2,zetaa)^2 + R2^2 + diff(R2,phii)^2)/(zetaa^2 - 1)); % Tropfenoberfäche  % Bestätigung
